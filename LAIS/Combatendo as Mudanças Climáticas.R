...
empty_names <- which(names(data) == "")
names(data)[empty_names] <- paste0("unknown_", seq_along(empty_names))


#Separando os grupos devido terem colunas diferentes

Grupo1 <- data[data$Grupo == '1' | data$Grupo == 'Grupo',]
Grupo1 <- Grupo1 %>%
  select(1:1, 12:19, 20:88, 292:299)

Grupo2 <- data[data$Grupo == '2' | data$Grupo == 'Grupo',]
Grupo2 <- Grupo2 %>%
  select(1:1, 12:19, 89:157, 292:299)

Grupo3 <- data[data$Grupo == '3' | data$Grupo == 'Grupo',]
Grupo3 <- Grupo3 %>%
  select(1:1, 12:19, 225:291, 292:299)

Grupo4 <- data[data$Grupo == '4' | data$Grupo == 'Grupo',]
Grupo4 <- Grupo4 %>%
  select(1:1, 12:19, 158:224, 292:299)


#Função para corrigir o cabeçalho
...
#Executa o script para cada Grupo
for (n in 1:4) {
  ...
  posicoes <- which(names(data) == "Não jogar lixo no chão")
  names(data)[posicoes[2]] <- "Não jogar lixo no chão second"
  ...
  data <- data %>%
    mutate (
      Climate_Change1 =
        if (Group %in% c(1, 4)) {
          case_when (
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '1 (Nada importante)' ~ 1,       
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '2' ~ 2,
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '3' ~ 3,       
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '4' ~ 4,
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '5' ~ 5,                         
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '6' ~ 6,                         
            `A mudança climática é causada pelas decisões e comportamentos das pessoas no passado e no presente. Cientistas concordam há mais de 30 anos que a mudança climática está acontecendo, mas as gerações mais velhas não fizeram o suficiente para impedi-la. Agora, os efeitos das mudanças climáticas já estão sendo vistos em todo o mundo e provavelmente serão piores no futuro.Isso significa que, quanto mais jovem você for agora, mais você irá experimentar os efeitos das mudanças climáticas. As gerações futuras provavelmente enfrentarão os piores efeitos, incluindo eventos climáticos extremos, como tempestades, secas e inundações.Jovens de todo o mundo começaram a criticar as pessoas mais velhas e os governos por não levarem a mudança climática a sério o suficiente. Eles estão exigindo que os tomadores de decisão comecem a agir de verdade com urgência.Nesta seção, estamos interessados em saber seus pensamentos e opiniões como um jovem nos dias de hoje.Como uma pessoa jovem, quão importante você acha que é proteger o meio ambiente?` == '7 (Extremamente importante)' ~ 7
          )
       }
      ...
      Climate_Change2 = 
          if (Group %in% c(1, 4)) {
            case_when (
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '1 (Nada preocupado)' ~ 1,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '2' ~ 2,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '3' ~ 3,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '4' ~ 4,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '5' ~ 5,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '6' ~ 6,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
            `Como uma pessoa jovem, de modo geral, quão preocupado(a) você está com as mudanças climáticas?` == '7 (Extremamente preocupado)' ~ 7
          )
      }
      else if (Group %in% c(2, 3)) {
        case_when (
      ...
      Climate_Change4 = 
        if (Group %in% c(1, 4)) {
          case_when (
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '1 (Nada preocupados)' ~ 1,                                                                                                               
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '2' ~ 2,                                                                                                                                  
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '3' ~ 3,                                                                                                                                  
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '4' ~ 4,                                                                                                                                  
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '5' ~ 5,                                                                                                                                  
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '6' ~ 6,                                                                                                                                  
            `Também gostaríamos de saber o que você acha que seus colegas (ou seja, outros jovens) pensam sobre as mudanças climáticas.O quanto você acha que outros jovens em geral no Brasil estão preocupados com as mudanças climáticas?` == '7 (Extremamente preocupados)' ~ 7
        )
      }
      else if (Group %in% c(2, 3)) {
        case_when (																																																							 
      ...
      Climate_Change6 = 
        if (Group == 1) {
          case_when (
            `Um estudo mostrou que a maioria dos brasileiros (64%) com mais de 60 anos não acredita que cientistas e ambientalistas exageram ao tratar da crise do clima, isto é, pessoas mais velhas acreditam nos alertas de cientistas, demonstrando preocupação em relação às mudanças climáticas.Quão surpreso(a) você está com esses resultados?` == '1 (Nada surpreso)' ~ 1,        
      ...
      else if (Group %in% c(3, 4)) {
        NA
      },
      Climate_Change7 = 
        if (Group %in% c(1, 4)) {
          case_when (
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '1 (Discordo completamente)' ~ 1,                                                                                                                                                                                                                  
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '2' ~ 2,                                                                                                                                                                                                                                           
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '3' ~ 3,                                                                                                                                                                                                                                           
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '4' ~ 4,                                                                                                                                                                                                                                           
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '5' ~ 5,                                                                                                                                                                                                                                           
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '6' ~ 6,                                                                                                                                                                                                                                           
            `É provável que a maioria das pessoas no Brasil faça sua parte no esforço conjunto para combater as mudanças climáticas` == '7 (Concordo completamente)' ~ 7
        )
      }
      else if (Group %in% c(2, 3)) {
        case_when (
      ...
      Climate_Change11 = 
        if (Group %in% c(1, 4)) {
          case_when (
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '1 (Discordo completamente)' ~ 1,                                                                                                                                                                                                                                                                                                                                                                                                                                                  
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '2' ~ 2,                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '3' ~ 3,                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '4' ~ 4,                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '5' ~ 5,                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '6' ~ 6,                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
            `Como jovem, há coisas que eu posso fazer na minha rotina diária para ajudar a combater as mudanças climáticas.` == '7 (Concordo completamente)' ~ 7
        )
       }
      else if (Group %in% c(2, 3)) {
          case_when (	
  ...
  data <- data %>%
    mutate (
      ...
      Garbage_Floor = case_when (
        `Não jogar lixo no chão second` == '1 (Nada provável)' ~ 1,
        `Não jogar lixo no chão second` == '2' ~ 2,                                                                                                                     
        `Não jogar lixo no chão second` == '3' ~ 3,                                                                                                                     
        `Não jogar lixo no chão second` == '4' ~ 4,                                                                                                                     
        `Não jogar lixo no chão second` == '5' ~ 5,                                                                                                                     
        `Não jogar lixo no chão second` == '6' ~ 6,                                                                                                                     
        `Não jogar lixo no chão second` == '7 (Extremamente provável)' ~ 7
      ),
      ...
      Bin_Separeted = case_when (
        ...
        `Usar uma lixeira separada para reciclagem (ou tentar convencer aqueles com quem você vive a fazerem isso)` == '3' ~ 3,                          
  ...
  data <- data %>%
    mutate(
      ...
      Visit_Amenities_Important =  
          if (Group %in% c(1, 4)) {
            case_when (
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '1 (Discordo completamente)' ~ 1,
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '2' ~ 2,                                                                                                
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '3' ~ 3,                                                                                                
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '4' ~ 4,                                                                                                
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '5' ~ 5,                                                                                                
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '6' ~ 6,                                                                                                
              `Como jovem, visitar amenidades ao ar livre é importante para mim.` == '7 (Concordo completamente)' ~ 7
              )
          }
          else if (Group %in% c(2, 3)) {
           case_when (
            `Visitar amenidades ao ar livre é importante para mim.` == '1 (Discordo completamente)' ~ 1,
      ...
      Visit_Amenities_Like =  
        if (Group %in% c(1, 4)) {
          case_when (
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '1 (Discordo completamente)' ~ 1,
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '2' ~ 2,                                                                                         
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '3' ~ 3,                                                                                         
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '4' ~ 4,                                                                                         
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '5' ~ 5,                                                                                         
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '6' ~ 6,                                                                                         
          `Como jovem, visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '7 (Concordo completamente)' ~ 7
        )
      }
      else if (Group %in% c(2, 3)) {
        case_when (
          `Visitar amenidades ao ar livre é algo que eu gosto de fazer.` == '1 (Discordo completamente)' ~ 1,
    ...
    #Filtrando apenas as colunas criadas
    if (Group == 1) {
      Grupo1 <- data %>% select(1, 87:200)
    } 
    else if (Group == 2) {
      Grupo2 <- data %>% select(1, 87:200)
    } 
    else if (Group == 3) {
      Grupo3 <- data %>% select(1, 85:198)
    } 
    else if (Group == 4) {
      Grupo4 <- data %>% select(1, 85:198)
    }
}

#Unindo toda a base
data <- bind_rows(Grupo1, Grupo2, Grupo3, Grupo4)

write.csv(data,'BaseFinal.csv')