...
data <- read_excel("Vulnerabilidade e Educação Financeira2.xlsx")
View(input_file)
output_dir <- "C:/MODELO_VUL_FIN/"
...
stargazer(fit_FL, fit_FL_hc, fit_VF, fit_VF_hc, fit_FF, fit_FF_hc, type = "text", out = "C:/MODELO_VUL_FINAN/Modelo_vul_finan.txt")

stargazer(fit_Crypto, fit_Crypto_hc,type = "text", out = "C:/MODELO_VUL_FINAN/crypto.txt")
