...
# Period for the Calibration: 2000-2004
DATE1_CALI00 <- as.Date("2000-01-06")
DATE2_CALI00 <- as.Date("2004-12-30")
...
vREG <- DISTINCT(DATATABLE$location)
nREG <- length(vREG)
