...
base <- base[, c("ORIGEM", "CODMUNRES", "CODMUNNATU", "IDADE", "def_sexo", "def_raca_cor", "def_escol", "causabas_capitulo", "causabas_categoria", "causabas_grupo", "causabas_subcategoria", "idade_obito", "ano_obito", "DTOBITO")]
